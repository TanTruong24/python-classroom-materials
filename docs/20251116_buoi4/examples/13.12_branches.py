...
A guitar has 6 strings that play (from lowest to highest) the notes E, A, D, G, B, and e. 
...
- Using \n for newlines may make creating the output statements simpler, using a single output string per chord. 
    In fact, you can copy-paste the above output examples between " " when using print(), 
    then delete white spaces and replace newlines with \n. Ex. print(" # Paste the output example here. ")
...
if chord == "G":
    ...
    print(f"{chord} is not a supported chord.")